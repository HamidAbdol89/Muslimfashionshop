            ...
            <div class="max-w-lg mx-auto bg-gray-900 text-white rounded-xl shadow-xl overflow-hidden relative card-hover">
                ...
                <div class="relative z-10">
                    ...
                    <div class="bg-gradient-to-r from-purple-700 to-blue-700 p-6 text-center rounded-t-xl fade-in">
                        <i class="fas fa-user-plus text-4xl mb-2 text-purple-300"></i>
                        <h1 class="text-3xl font-bold mb-2">Thêm User mới</h1>
                        <p class="text-sm text-gray-300">Nhập thông tin để tạo user mới</p>
                    </div>
                    ...
                    <div class="p-6 fade-in">
                        <form action="{{ route('users.store') }}" method="POST" enctype="multipart/form-data" class="space-y-6">
                            ...
                            <div>
                                ...
                                <input type="text" class="w-full mt-1 px-4 py-3 bg-gray-800 text-white rounded-lg border border-gray-700 focus:ring-2 focus:ring-purple-500 focus:outline-none" name="name" placeholder="Nhập tên" required>
                            </div>
...
<div>
    ...
    <input type="email" 
           class="w-full mt-1 px-4 py-3 bg-gray-800 text-white rounded-lg border border-gray-700 focus:ring-2 focus:ring-blue-500 focus:outline-none"
           name="email" 
           placeholder="Nhập email" 
           required 
           autocomplete="off"> <!-- Tắt tính năng tự động điền -->
</div>
...
<div>
    ...
    <input type="password" 
           class="w-full mt-1 px-4 py-3 bg-gray-800 text-white rounded-lg border border-gray-700 focus:ring-2 focus:ring-purple-500 focus:outline-none"
           name="password" 
           placeholder="Nhập password" 
           required 
           autocomplete="new-password"> <!-- Tắt tính năng tự động điền cho mật khẩu -->
</div>
