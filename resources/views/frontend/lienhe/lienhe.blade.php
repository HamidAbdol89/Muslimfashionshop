                                ...
                                <div class="row align-items-lg-center justify-content-center h-100">
                                    <div class="col-11 col-xl-10">
                                        <div class="contact-info-wrapper py-4 py-xl-5">
                                            <h2 class="h1 mb-3 text-light">Liên hệ ngay</h2>
                                            <p class="lead fs-4 text-light opacity-75 mb-4 mb-xxl-5">Chúng tôi luôn tìm
                                                kiếm để làm việc với khách hàng mới. Nếu bạn quan tâm đến việc làm việc
                                                với chúng tôi, vui lòng liên hệ theo một trong các cách sau.</p>
                                            <div class="d-flex mb-4 mb-xxl-5">
                                                ...
                                                <div>
                                                    ...
                                                    <address class="mb-0 text-light opacity-75">182/7, Khóm Đông Thịnh
                                                        8, P. Mỹ Phước, Thành phố Long Xuyên, An Giang</address>
                                                </div>
                                            </div>
                                                ...
                                                <div class="col-12 col-xxl-6">
                                                    <div class="d-flex mb-0">
                                                        ...
                                                        <div>
                                                            ...
                                                            <p class="mb-0">
                                                                <a class="link-light link-opacity-75 link-opacity-100-hover text-decoration-none"
                                                                    href="hamidabdol2002@gmail.com">hamidabdol2002@gmail.com</a>
                                                            </p>
                                                        </div>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="d-flex">
                                                ...
                                                <div>
                                                    <h4 class="mb-3 text-light">Mở cửa</h4>
                                                    <div class="d-flex mb-1">
                                                        <p class="text-light fw-bold mb-0 me-5">thứ 2 - chủ nhật</p>
                                                        <p class="text-light opacity-75 mb-0">7h - 21h</p>
                                                    </div>
                                    ...
                                    <div class="col-12">
                                        <form action="{{ route('frontend.contact.submit') }}" method="POST">
                                            ...
                                            <div class="row gy-4 gy-xl-5 p-4 p-xl-5">
                                                <div class="col-12">
                                                    <label for="fullname" class="form-label">Tên đầy đủ <span
                                                ...
                                                <div class="col-12">
                                                    <div class="d-grid">
                                                        <button class="btn btn-primary btn-lg" type="submit">Gửi
                                                            ngay</button>
                                                    </div>
                                                </div>
                                            </div>
...
<!-- Thêm SweetAlert2 vào phần <head> -->
